...
import com.example.secondentity.SecondHospitalBedAvailability;
...
public interface SecondHospitalBedAvailabilityRepository extends JpaRepository<SecondHospitalBedAvailability, String> {

    @Modifying
    @Query(value = "INSERT INTO hospital_bed_availability (" +
            "hpid, hvec, hvoc, hvcc, hvncc, hvccc, hvicc, hvgc, hv2, hv3, hv4, hv5, hv6, hv7, " +
            ...
            "hvcrrtayn, hvecmoayn, hvoxyayn, hvhypoayn, hvamyn, operation_rate, hvidate, updated_at) " +
            "VALUES (" +
            ":hpid, :hvec, :hvoc, :hvcc, :hvncc, :hvccc, :hvicc, :hvgc, :hv2, :hv3, :hv4, :hv5, :hv6, :hv7, " +
            ":hv8, :hv9, :hv10, :hv11, :hv13, :hv14, :hv15, :hv16, :hv17, :hv18, :hv19, :hv21, :hv22, :hv23, :hv24, " +
            ":hv25, :hv26, :hv27, :hv28, :hv29, :hv30, :hv31, :hv32, :hv33, :hv34, :hv35, :hv36, :hv37, :hv38, :hv39, " +
            ":hv40, :hv41, :hv42, :hv43, :hvctayn, :hvmriayn, :hvangioayn, :hvventiayn, :hvventisoayn, :hvincuayn, " +
            ":hvcrrtayn, :hvecmoayn, :hvoxyayn, :hvhypoayn, :hvamyn, :operation_rate, :hvidate, :updatedAt) " +
            ...
            "operation_rate = EXCLUDED.operation_rate, hvidate = EXCLUDED.hvidate, updated_at = NOW()",
            nativeQuery = true)
    void saveOrUpdate(
            ...
            @Param("operation_rate") Integer operation_rate,
